...
Pod::Spec.new do |spec|
  ...
  spec.source       = { :http => 'https://dfp-fp-sdk-dev.azureedge.net/sdk/cocoapod/framework/' + spec.version.to_s + '/podcontent.tar.gz' }

  spec.ios.deployment_target = '11.0'
  spec.swift_version = '5.0'
  spec.vendored_frameworks = 'DynamicsFP.framework'
